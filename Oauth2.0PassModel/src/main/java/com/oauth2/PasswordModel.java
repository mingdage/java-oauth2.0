...
public class PasswordModel {
	...
	public static String getAuth() throws Exception {
		...
		//返回加密授权
		return getAuth("endy",MD5(password));
	}

	// 获取token
	public static String getAuth(String name, String password) throws Exception {
		// 接口地址
		...
		try {
			...
			//设置HTTP请求的请求体BODY  将body参数post进流中
			String params = "grant_type=" + "password" + "&scope=" + "api1" + "&username=" + "endy" + "&password="
					+ password;
	...
	public static String MD5(String password) {
		try {
			...
			//加密内容
			String addSecurity = "matrix" + password;
			byte[] result = digest.digest(addSecurity.getBytes());
			StringBuilder strbul = new StringBuilder(40);
			//StringBuffer strbul = new StringBuffer(40);
            ...
            // 标准的md5加密后的结果   大写
            return strbul.toString().toUpperCase();
